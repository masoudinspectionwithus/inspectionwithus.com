...
import roughness from "@/public/images/photo_33_2023-11-27_16-16-54.jpg";
import salt from "@/public/images/Salt-contamination-check.jpg";
import CMMPost from "./CmmPost";

export default function Zigzag() {
  return (
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
        <h1 className="h2 text-center mb-8">EXPLORING PRECISION: YOUR GUIDE TO QUALITY INSPECTION</h1>
        <p className="text-xl text-gray-400 text-center mb-12">
          At Inspection with Us, we specialize in comprehensive quality inspection...
        </p>

        <div className="grid gap-8">
          {/* Link to each post */}
          <a href="/blog/CmmPost" className="text-xl text-blue-500 underline">
            Unveiling the Role of CMM in Quality Inspection
          </a>
          <a href="/blog/SectorPost" className="text-xl text-blue-500 underline">
            Sectors
          </a>
          <a href="/RoughnessPost" className="text-xl text-blue-500 underline">
            Keep projects on schedule
          </a>
          <a href="/SaltPost" className="text-xl text-blue-500 underline">
